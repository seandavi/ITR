...
```
## [1] 0.5793055 1.2097885 0.5917524
```
...
```
## [1] -0.34817340 -0.05373096 -1.39735070 -2.28365537  0.06035940 -2.80074568
## [7] -0.97705989
```
...
```
##        V1               V2         
##  Min.   : 72.23   Min.   :-35.923  
##  1st Qu.: 89.63   1st Qu.:-10.231  
##  Median :117.39   Median : -8.703  
##  Mean   :108.27   Mean   : -5.918  
##  3rd Qu.:125.41   3rd Qu.:  2.815  
##  Max.   :129.41   Max.   : 24.057
```
...
```
##      x   y                    z   
## [1,] "1" "0.900800737162549"  "a1"
## [2,] "2" "0.0906355914679877" "a2"
## [3,] "3" "-0.20766895374775"  "a3"
## [4,] "4" "1.15935723951938"   "a4"
```
...
```
##      x           y  z
## row1 1  0.90080074 a1
## row2 2  0.09063559 a2
## row3 3 -0.20766895 a3
## row4 4  1.15935724 a4
## row5 5 -1.60166742 a5
## row6 6  1.03836731 a6
```
...
```
##  [1]  0.90080074  0.09063559 -0.20766895  1.15935724 -1.60166742
##  [6]  1.03836731  1.30768940 -0.16766822  0.42791426 -0.48440330
```
...
```
##       col1            col2              col3  
##  Min.   : 1.00   Min.   :-1.6017   a1     :1  
##  1st Qu.: 3.25   1st Qu.:-0.1977   a10    :1  
##  Median : 5.50   Median : 0.2593   a2     :1  
##  Mean   : 5.50   Mean   : 0.2463   a3     :1  
##  3rd Qu.: 7.75   3rd Qu.: 1.0040   a4     :1  
##  Max.   :10.00   Max.   : 1.3077   a5     :1  
##                                    (Other):4
```
