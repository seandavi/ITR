...
```
## [1] 0.8386700 2.5270888 1.8484906 1.6477362 0.6594236 2.5636102
```
...
```
## [1] -0.4583701 -0.3723138 -0.4451370 -0.7341693
```
...
```
##        V1               V2         
##  Min.   : 81.21   Min.   :-29.178  
##  1st Qu.: 82.00   1st Qu.: -6.521  
##  Median : 86.82   Median :  1.643  
##  Mean   : 91.60   Mean   :  3.591  
##  3rd Qu.:102.56   3rd Qu.:  6.752  
##  Max.   :107.12   Max.   : 39.894
```
...
```
##      x   y                    z   
## [1,] "1" "-0.92602857096029"  "a1"
## [2,] "2" "1.51288832985976"   "a2"
## [3,] "3" "0.0161625713223032" "a3"
## [4,] "4" "1.35109911521925"   "a4"
```
...
```
##      x           y  z
## row1 1 -0.92602857 a1
## row2 2  1.51288833 a2
## row3 3  0.01616257 a3
## row4 4  1.35109912 a4
## row5 5 -0.60914759 a5
## row6 6  0.94849648 a6
```
...
```
##  [1] -0.92602857  1.51288833  0.01616257  1.35109912 -0.60914759
##  [6]  0.94849648 -0.70250338  0.07497098 -0.59131121  0.24393806
```
...
```
##       col1            col2               col3  
##  Min.   : 1.00   Min.   :-0.92603   a1     :1  
##  1st Qu.: 3.25   1st Qu.:-0.60469   a10    :1  
##  Median : 5.50   Median : 0.04557   a2     :1  
##  Mean   : 5.50   Mean   : 0.13186   a3     :1  
##  3rd Qu.: 7.75   3rd Qu.: 0.77236   a4     :1  
##  Max.   :10.00   Max.   : 1.51289   a5     :1  
##                                     (Other):4
```
...
```
##       col1        col2 col3
## row8     8  0.07497098   a8
## row9     9 -0.59131121   a9
## row10   10  0.24393806  a10
```
...
<img src="B3_files/figure-html/unnamed-chunk-48-1.png" width="672" />
...
<img src="B3_files/figure-html/unnamed-chunk-49-1.png" width="672" />
...
<img src="B3_files/figure-html/unnamed-chunk-50-1.png" width="672" />
...
<img src="B3_files/figure-html/unnamed-chunk-51-1.png" width="672" />
